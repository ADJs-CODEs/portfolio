...
const Skills = () => {
  ...
  return <section id='skills' className='relative py-20 bg-black overflow-hidden'>
    ...
    <div className='absolute inset-0 overflow-hidden'>
      ...
      <div className='absolute bottom-1/4 right-0 w-96 h-96 bg-primary/10 rounded-full blur-3xl opacity-' />
    </div>
      ...
      <FadeIn delay={100}>
        <div className='text-center'>
          <div className='inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6'>
            <Icons.Sparkles className='w-4 text-primary h-4' />
          ...
          <p className='text-lg text-white/60 max-w-2xl mx-auto'>
            A comprehensive overview of my techniacal skills and proficiency level
          </p>
        </div>
      </FadeIn>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className='relative h-1.5 bg-white/5 rounded-full overflow-hidden'>
                        <div
                          className='absolute top-0 h-full bg-linear-to-r from-primary/10 to-primary/80 rounded-full transition-all duration-1000 ease-out'
