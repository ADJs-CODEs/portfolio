import { Github, Linkedin, Mail, Twitter, Dribbble, MapPin, Heart } from 'lucide-react'
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-12 mb-12'>
          ...
          <FadeIn delay={200}>
            <div>
              ...
              <p className='text-white/60 text-sm mb-6 leading-relaxed'>
                Let's Connect and create something <span className='text-red-700'>Mind</span>blowing together
              </p>
