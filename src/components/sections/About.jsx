...
import { SiReact, SiNextdotjs, SiTailwindcss, SiNodedotjs, SiMongodb, SiPrimereact, SiTypescript } from 'react-icons/si';
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
            {skills.map((skill, index) => (
              <div key={index}
                className="group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary/50 rounded-2xl p-6 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105"
              >
