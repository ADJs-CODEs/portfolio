  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: '2f5a5832-2456-417c-b009-150971389088',
          name: formData.name,
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <FadeIn delay={0}>
          <div className='text-center mb-16'>
            ...
            <h2 className='text-4xl font-normal text-white mb-4 lg:text-5xl'>
              Let's work Together
            </h2>
            <p className='text-lg text-white/60 max-w-2xl mx-auto'>
              have a project in mind? Lets's Brainstorm and make it happen.
            </p>
          </div>
        </FadeIn>
            ...
            <div className='space-y-8'>
              <div>
                ...
                <p className='text-white/60 leading-relaxed '>
                  I'm excited to explore new projects, innovative ideas, and opportunities to bring your vision to life. Don't hesitate to get in touch.
                </p>
              </div>
                ...
                <div className='group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                  <div className='flex items-start gap-4'>
                    <div className='p-3 bg-linear-to-br from-primary/20 to-primary/20 border border-primary/30 rounded-xl'>
                      <Mail className='w-6 h-8 text-primary' />
                    </div>

                    <div className='flex-1'>
                      <p className='text-sm text-white/60 mb-1'>Email</p>
                      <a href={`mailto:${PERSONAL_INFO}`}
