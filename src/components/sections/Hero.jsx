          ...
          <div className="text-left">
            ...
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-137.5 mb-8">
                Building modern, scalable web applications with React, JavaScript and cutting-edge technologies, Transforming ideas into expceptional digital experiences.
              </p>
            </FadeIn>
            <FadeIn delay={300}>
              <button
              ...
              >
                <div className="relative z-10 bg-white text-[#212121] rounded-[17px] px-6.5 py-3.25 text-base font-mediumborder border-white" >
                  Get in Touch
                </div>
